...
if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
    ...
    S.GUI.ChirpReward = 8; 
    S.GUI.ITI = 10; % How long the mouse must poke in the center to activate the goal portngjhg
...
%                 'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
            ...
            %FOR DOI I HAVE TO ADD A STATE TIMER
             sma = AddState(sma, 'Name', 'Chirp1', ...
                'Timer',2.5,...
                'StateChangeConditions', {'Tup','Laser','Port1Out','Laser','Port2Out','Laser','Port3Out','Laser','Port4Out','Laser','Port5Out','Laser','GlobalTimer2_End','exit'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50 'PWM7', 50});
% % % Wire 2 denotes the Playing of the Chirp (65530)            
             ...
             sma = AddState(sma, 'Name', 'Laser', ...
                ...
                'OutputActions',[LazerON,'Wire2',1,'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50]);
