...
trainingMeans = smooth(mean(performanceStruct.all, 2, 'omitnan'), 1);
trainingSEM = smooth(std(performanceStruct.all, 0, 2, 'omitnan')./sqrt(size(performanceStruct.all, 2)), 1);
