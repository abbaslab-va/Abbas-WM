function proportionEW = DMTS_tri_training_early_withdrawals(trainingSessions, delayBins)
...
proportionEW = arrayfun(@(x) [x.early.mean, x.mid.mean, x.late.mean], ewByEra, 'uni', 0)
