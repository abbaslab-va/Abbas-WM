function NMTP_Outer_Testing_Pulsatile
...
for fill = 1:7
    baselineblock = randperm(4);
    BaselineTrialTypes(fill*4-3:fill*4) = baselineblock;
end

BaselineTrialTypes = BaselineTrialTypes +16;
...
TrialTypes = [BaselineTrialTypes TrialTypes];
...
Pulse10 = [0, .1];
V10 = [4, 4];
Pulse40 = [0 .025 .05 .075];
V40 = [4 4 4 4];
% ProgramPulsePalParam(1, 10, S.GUI.ProtocolTime);
% ProgramPulsePalParam(1, 4, stimTime)
...
% ProgramPulsePalParam(2, 4, stimTime)
...
for currentTrial = 1:MaxTrials
    ...
    downTime = (1/freq)- stimTime;
    mod(TrialTypes(currentTrial),4)
    switch freq
        case 10
            SendCustomPulseTrain(1, Pulse10, V10)
            SendCustomPulseTrain(2, Pulse10, V10)
ProgramPulsePalParam(1, 10, S.GUI.ProtocolTime);
ProgramPulsePalParam(1, 4, stimTime)
ProgramPulsePalParam(1, 11 , 0);
ProgramPulsePalParam(1, 12, 1);
...
ProgramPulsePalParam(2, 128, 2);
        case 40
            SendCustomPulseTrain(1, Pulse40, V40)
            SendCustomPulseTrain(2, Pulse40, V40)
ProgramPulsePalParam(1, 10, S.GUI.ProtocolTime);
ProgramPulsePalParam(1, 4, stimTime)
ProgramPulsePalParam(1, 11 , 0);
ProgramPulsePalParam(1, 12, 1);
