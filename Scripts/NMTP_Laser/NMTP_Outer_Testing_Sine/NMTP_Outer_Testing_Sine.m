function NMTP_Outer_Testing_Sine
...
for currentTrial = 1:MaxTrials
    ...
    sineWave = 2*(1+sin(2*pi*freq*t-pi/2));
    sineWave = sineWave(1:1000);
    SendCustomWaveform(1, 0.0001, sineWave);
    SendCustomWaveform(2, 0.0001, sineWave);
