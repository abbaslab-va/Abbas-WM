...
function CLAS_testing_POsuppress
...
switch TrialTypes(currentTrial)
    ...
    case 8
      ...
      % case 9:12 Chirp with laser OFF    
    case 9
        PickDur=10
        PickDur2=1
        %PickNoise=1
...
%First Wire (65529) Stamps begining on Trial Start (Start of ITI)
        %First Wire (65529) Stamps begining on Trial Start (Start of ITI)
         sma = AddState(sma, 'Name', 'ITI', ...
            'Timer',S.GUI.ITI,...
            'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','Port7Out','GoBack','Tup','WaitForAPoke'},...
            'OutputActions',{'Wire1',1});
        %Added a tup for DOI
         sma = AddState(sma, 'Name', 'WaitForAPoke', ...
            'Timer',3,...
            'StateChangeConditions', {'Port1In','TriggerTimers1','Port2In','TriggerTimers1','Port3In','TriggerTimers1','Port4In','TriggerTimers1','Port5In','TriggerTimers1','Tup','TriggerTimers1'},...
...
% %         
 ...
 %Wire 1 & 2=65531= Reward Forage Port        
        ...
        sma = AddState(sma, 'Name', 'Reward1', ...
                'Timer',0,...
                'StateChangeConditions', {'Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','GlobalTimer1_End','Chirp1','Port1In','Reward1_1','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});
     ...
     sma = AddState(sma, 'Name', 'Laser', ...
        'Timer',0.1,...
        'StateChangeConditions', {'Tup','Reward1','GlobalTimer2_End','exit'},...
        ...
        sma = AddState(sma, 'Name', 'Reward1_1', ...
         ...
         sma = AddState(sma, 'Name', 'Reward2', ...
                'Timer',0,...
                'StateChangeConditions', {'Port1Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','GlobalTimer1_End','Chirp1','Port2In','Reward2_1','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50,'PWM7', 50});
         ...
         sma = AddState(sma, 'Name', 'Reward3', ...
                'Timer',0,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','GlobalTimer1_End','Chirp1','Port3In','Reward3_1','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});
         ...
         sma = AddState(sma, 'Name', 'Reward4', ...
                'Timer',0,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port5Out','GoBack','GlobalTimer1_End','Chirp1','Port4In','Reward4_1','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});
           ...
           sma = AddState(sma, 'Name', 'Reward5', ...
                'Timer',0,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack''GlobalTimer1_End','Chirp1','Port5In','Reward5_1','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});
...
%                 'OutputActions',{'Valve7',1,'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});
            ...
            sma = AddState(sma, 'Name', 'DrinkGrace1', ...
                ...
                'StateChangeConditions', {'Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','GlobalTimer1_End','Chirp1','Tup','Port1InMark','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
            
              sma = AddState(sma, 'Name', 'DrinkGrace2', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','GlobalTimer1_End','Chirp1','Tup','Port2InMark','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
              
            sma = AddState(sma, 'Name', 'DrinkGrace3', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port4Out','GoBack','Port5Out','GlobalTimer1_End','Chirp1','Tup','Port3InMark','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
              
            sma = AddState(sma, 'Name', 'DrinkGrace4', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port5Out','GlobalTimer1_End','Chirp1','Tup','Port4InMark','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
            
            sma = AddState(sma, 'Name', 'DrinkGrace5', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GlobalTimer1_End','Chirp1','Tup','Port5InMark','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
...
%                 'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
            ...
            %FOR DOI I HAVE TO ADD A STATE TIMER
             sma = AddState(sma, 'Name', 'Chirp1', ...
                ...
                'OutputActions',{'SoftCode',6,'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50 'PWM7', 50});


             sma = AddState(sma, 'Name', 'GoBack', ...
                'Timer',0.1,...
                'StateChangeConditions', {'GlobalTimer2_End','exit','Tup','>Back'},...
                'OutputActions',[LaserON,'Wire2',1,'Wire3','PWM1',1,50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50 'PWM7', 50]);
...
% % % Wire 2 denotes the Playing of the Chirp (65530)   
             ...
             sma = AddState(sma, 'Name', 'WaitForChirp1', ...
               'Timer',time1,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','Tup','WaitForChirp2','Port7In','Reward','GlobalTimer2_End','exit'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});          
              
            
            sma = AddState(sma, 'Name', 'WaitForChirp2', ...
               'Timer',time2,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','Tup',chirptrial,'Port7In','Reward','GlobalTimer2_End','exit', PortIn, 'ExtraFrontIn'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});          
            ...
            sma = AddState(sma, 'Name', 'ExtraFrontIn', ...
             ...
             sma = AddState(sma, 'Name', 'ExtraFrontGrace', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','Tup','WaitForChirp3','GlobalTimer2_End','exit','Port7In','Reward'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
             ...
             sma = AddState(sma, 'Name', 'ExtraFrontGrace2', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','Tup','Abort','GlobalTimer2_End','exit','Port7In','Reward'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
...
%         
            sma = AddState(sma, 'Name', 'Reward', ...
                'Timer',rewardtime1,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','Port7Out','GoBack','Tup','DrinkGrace7','GlobalTimer2_End','exit'},...
                'OutputActions',{'Valve7',1,'Wire3',1,'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});
%             
             sma = AddState(sma, 'Name', 'DrinkGrace7', ...
                'Timer',rtime,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','Port7Out','GoBack','Tup','WaitForFirstPoke','GlobalTimer2_End','exit'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});
