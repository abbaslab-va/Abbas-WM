...
%                 'OutputActions',{'Valve7',1,'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});
            ...
            sma = AddState(sma, 'Name', 'DrinkGrace1', ...
              ...
              sma = AddState(sma, 'Name', 'DrinkGrace2', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','GlobalTimer1_End','Chirp1','Tup','Port2InMark','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
              
            sma = AddState(sma, 'Name', 'DrinkGrace3', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','GlobalTimer1_End','Chirp1','Tup','Port3InMark','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
              
            sma = AddState(sma, 'Name', 'DrinkGrace4', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port5Out','GoBack','GlobalTimer1_End','Chirp1','Tup','Port4InMark','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
            
            sma = AddState(sma, 'Name', 'DrinkGrace5', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','GlobalTimer1_End','Chirp1','Tup','Port5InMark','GlobalTimer2_End','exit','Port7In','Punish'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
...
%                 'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
            ...
            %FOR DOI I HAVE TO ADD A STATE TIMER
             ...
             sma = AddState(sma, 'Name', 'GoBack', ...
                'Timer',0,...
                'StateChangeConditions', {'GlobalTimer1_End','Chirp1','GlobalTimer2_End','exit','Tup','>back'},...
...
% % % Wire 2 denotes the Playing of the Chirp (65530)   
             ...
             sma = AddState(sma, 'Name', 'WaitForChirp1', ...
               'Timer',time1,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','Tup','WaitForChirp2','Port7In','Reward','GlobalTimer2_End','exit'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});          
              
            
            sma = AddState(sma, 'Name', 'WaitForChirp2', ...
               'Timer',time2,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','Tup',chirptrial,'Port7In','Reward','GlobalTimer2_End','exit', PortIn, 'ExtraFrontIn'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});          
            ...
            sma = AddState(sma, 'Name', 'ExtraFrontIn', ...
             ...
             sma = AddState(sma, 'Name', 'ExtraFrontGrace', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','Tup','WaitForChirp3','GlobalTimer2_End','exit','Port7In','Reward'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
             ...
             sma = AddState(sma, 'Name', 'ExtraFrontGrace2', ...
                'Timer',S.GUI.DrinkGrace,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','Tup','Abort','GlobalTimer2_End','exit','Port7In','Reward'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50}); 
...
%         
            sma = AddState(sma, 'Name', 'Reward', ...
                'Timer',rewardtime1,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','Port7Out','GoBack','Tup','DrinkGrace7','GlobalTimer2_End','exit'},...
                'OutputActions',{'Valve7',1,'Wire3',1,'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});
%             
             sma = AddState(sma, 'Name', 'DrinkGrace7', ...
                'Timer',rtime,...
                'StateChangeConditions', {'Port1Out','GoBack','Port2Out','GoBack','Port3Out','GoBack','Port4Out','GoBack','Port5Out','GoBack','Port7Out','GoBack','Tup','WaitForFirstPoke','GlobalTimer2_End','exit'},...
                'OutputActions',{'PWM1', 50,'PWM2', 50,'PWM3', 50,'PWM4', 50,'PWM5', 50, 'PWM7', 50});
