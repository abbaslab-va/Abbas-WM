...
for fill = 1:10 %(outer blocks randomized here) (10 repeats of each trialtype/stimtype combo (6 trialtypes, 2 stimtypes)
    block = [zeros(1,6), ones(1,6)]; % opto stim conditions, 0 means no stim
    shuff_idx = randperm(12);
    block = block(shuff_idx);
    StimTypes(fill*12-(12-1):fill*12) = block;
...
BpodSystem.Data.Task_name = 'DMTS_Tri_Delay_stim_only';
