...
%% Main trial loop - First half
for currentTrial = 1:60 %MaxTrials
...
disp('Pausing for DOI injection...')
% Add in the pause until I say go functionality here.
Start_second_block = 0;
while Start_second_block~=1
    Start_second_block = input('Input 1 to continue');
    if isempty(Start_second_block)
        Start_second_block = 0;
    end
end
disp('Roger Roger, Continuing with second half of task.')
%% Main trial loop - second half
for currentTrial = 61:MaxTrials
